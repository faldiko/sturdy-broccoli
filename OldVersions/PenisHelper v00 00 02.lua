...
local OthersCheckBox = {
    { u8'Ðûáèé Ãëàç', u8'Äîáàâëþ', camera_zoom_enabled }
}
...
function sampev.onShowDialog(dialogId, style, title, button1, button2, text) if prokachka[0] then if text:match('{FFFFFF}Áóäåò ãîòîâ ÷åðåç:') then sampSendDialogResponse(dialogId, 1, 1, nil) return false end end end
